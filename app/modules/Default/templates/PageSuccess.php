...
<li>
<a target="_blank" title="<?php echo $r['MainSubject'];?>" href="<?php echo $ro->gen('download.continue',array('id' => $r['Id'],'subject' => $r['ShortSubject'])); ?>">:: <?php echo $r['MainSubject']; ?>  <span style="font-size:10px;">[<?php echo $r['Id']; ?>]</span></a>
</li>
<?php }?>
<?php endforeach;?>
</ul>
...
<div class="pagination clearfix">
            ...
            <li>
            <a href="<?php echo $ro->gen('page',array('id' => $p));?>"><?php echo $p;?></a>
            </li>
            <?php endforeach;?>
			</ul>
		</div>
