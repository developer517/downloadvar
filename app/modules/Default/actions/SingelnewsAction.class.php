...
class Default_SingelnewsAction extends downloadvarDefaultBaseAction
{
	/**
...
public function executeRead(AgaviRequestDataHolder $rd)
	{
		...
		$mat = NewsQuery::create()->findPks($id);
		...
		/* end */
		$ne =  NewsQuery::create()->find();
		$this->setAttribute('ne', $ne->toArray());
		return 'Success';
