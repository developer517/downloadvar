...
<span class="active">افزودن یک مطلب جدید</span>
</div>
<div id="inner">
<div class="nav_tabs">
...
<form method="post" action="<?php echo $ro->gen('news.matter.create.add'); ?>">
	...
	<tbody>
		<tr class="alt_row">
			<td style="" class="first">
				<label for="main_subject">عنوان اصلی:  <em>*</em></label>
					...
					<div class="form_row">
						<input type="text" id="short_subject" class="text_input" name="short_subject">
					</div>
			</td>
		</tr>
			...
			<label for="order">اولویت: <em>*</em></label>
				<select name="order">
				<option value="<?php echo 1000 - count(MatterQuery::create()->find());?>"><?php echo 1000 - count(MatterQuery::create()->find());?></option>
				</select>
			</td>
		</tr>
				<tr>
			...
			<label for="long_desc">توضیح:<em>*</em></label>
				...
				<div class="form_row">
				<textarea cols="45" rows="5" id="english_desc" name="english_desc" ></textarea>
				</div>
				<label for="help_desc">راهنمای نصب:</label>
				<div class="form_row">
				<textarea cols="45" rows="5" id="help_desc" name="help_desc" ></textarea>
				</div>
					<label for="download_link">لینک های دانلود:<em>*</em></label>
				<div class="form_row">
				<textarea cols="45" rows="5" id="download_link" name="download_link" ></textarea>
				</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<label for="tag_keywords">برچسب ها:<em>*</em></label>
				<div class="form_row">
				<textarea cols="45" rows="5" id="tag_keywords" name="tag_keywords"></textarea>
				</div>
			</td>
		</tr>
