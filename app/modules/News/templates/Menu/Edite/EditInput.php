...
<span class="active">ویرایش یک مجموعه </span>
</div>
<div id="inner">
<div class="nav_tabs">
...
<form method="post" action="<?php echo $ro->gen('news.menu.edite.edit',array('id' => $one_category['Id'])); ?>">
<div class="border_wrapper">
<div class="title">ویرایش یک مجموعه</div>
		...
		<tr class="alt_row">
			<td style="" class="first">
				<label for="pname">نام فارسی:  <em>*</em></label>
					<div class="form_row">
						<input value="<?php echo $one_category['PersianName'];?>" type="text" id="pname" class="text_input" name="pname">
					</div>
			</td>
		</tr>
			<tr class="alt_row">
			<td style="" class="first">
				<label for="ename">نام انگلیسی:  <em>*</em></label>
					<div class="form_row">
						<input value="<?php echo $one_category['EnglishName'];?>" type="text" id="ename" class="text_input"  name="ename">
					</div>
			</td>
		</tr>
		<tr>
			...
			<label for="desc">متاتگ Description:<em>*</em></label>
				<div class="form_row">
				<textarea cols="45" rows="5" id="desc" name="desc" ><?php echo $one_category['Description'];?></textarea>
				</div>
			</td>
		</tr>
		<tr>
			...
			<label for="tag">برچسب ها:<em>*</em></label>
				<div class="form_row">
				<textarea cols="45" rows="5" id="tag" name="tag"><?php echo $one_category['Tag'];?></textarea>
				</div>
			</td>
		</tr>
