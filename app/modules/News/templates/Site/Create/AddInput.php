...
<span class="active">افزودن یک مطلب خبری</span>
</div>
<div id="inner">
<div class="nav_tabs">
<div class="tab_description">
.:: در این بخش شما میتوانید یک مطلب خبری ایجاد کنید ::.
</div>
<div class="tab_description">
.:: در صورت ایجاد خبر شما به صفحه اصلی بخش مدیریت هدایت میشوید در غیر اینصورت به همین صفحه باز میگردید ::. 
</div>
<div class="tab_description">
...
<form method="post" action="<?php echo $ro->gen('news.site.create.add'); ?>">
<div class="border_wrapper">
<div class="title">افزودن یک خبر</div>
