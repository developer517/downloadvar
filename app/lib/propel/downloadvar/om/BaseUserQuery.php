 ...
 *
 * @method UserQuery leftJoinMatter($relationAlias = null) Adds a LEFT JOIN clause to the query using the Matter relation
 * @method UserQuery rightJoinMatter($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Matter relation
 * @method UserQuery innerJoinMatter($relationAlias = null) Adds a INNER JOIN clause to the query using the Matter relation
 *
...
abstract class BaseUserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'downloa3_downloadvar', $modelName = 'User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `username`, `password`, `email`, `mobile` FROM `user` WHERE `id` = :p0';
        try {
    ...
    public function filterByMatter($matter, $comparison = null)
    {
        if ($matter instanceof Matter) {
            return $this
                ->addUsingAlias(UserPeer::ID, $matter->getUserId(), $comparison);
