 ...
 * @method NewsQuery orderByOrder($order = Criteria::ASC) Order by the order column
 * @method NewsQuery orderByDate($order = Criteria::ASC) Order by the date column
 * @method NewsQuery orderByDesc($order = Criteria::ASC) Order by the desc column
 *
 * @method NewsQuery groupById() Group by the id column
 * @method NewsQuery groupBySubject() Group by the subject column
 * @method NewsQuery groupByOrder() Group by the order column
 * @method NewsQuery groupByDate() Group by the date column
 * @method NewsQuery groupByDesc() Group by the desc column
 *
 ...
 * @method News findOneByOrder(int $order) Return the first News filtered by the order column
 * @method News findOneByDate(string $date) Return the first News filtered by the date column
 * @method News findOneByDesc(string $desc) Return the first News filtered by the desc column
 *
 ...
 * @method array findByOrder(int $order) Return News objects filtered by the order column
 * @method array findByDate(string $date) Return News objects filtered by the date column
 * @method array findByDesc(string $desc) Return News objects filtered by the desc column
 *
...
abstract class BaseNewsQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'downloa3_downloadvar', $modelName = 'News', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `subject`, `order`, `date`, `desc` FROM `news` WHERE `id` = :p0';
        try {
    ...
    public function filterByOrder($order = null, $comparison = null)
    {
        if (is_array($order)) {
            $useMinMax = false;
            if (isset($order['min'])) {
                $this->addUsingAlias(NewsPeer::ORDER, $order['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($order['max'])) {
                $this->addUsingAlias(NewsPeer::ORDER, $order['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NewsPeer::ORDER, $order, $comparison);
    }
    ...
    public function filterByDesc($desc = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NewsPeer::DESC, $desc, $comparison);
    }
