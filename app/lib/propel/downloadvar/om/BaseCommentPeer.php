...
abstract class BaseCommentPeer
{
    ...
    const DESC = 'comment.desc';

    /** the column name for the action field */
    const ACTION = 'comment.action';

    /** the column name for the matter_id field */
    const MATTER_ID = 'comment.matter_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Email', 'Website', 'Date', 'Desc', 'Action', 'MatterId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'email', 'website', 'date', 'desc', 'action', 'matterId', ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID, CommentPeer::NAME, CommentPeer::EMAIL, CommentPeer::WEBSITE, CommentPeer::DATE, CommentPeer::DESC, CommentPeer::ACTION, CommentPeer::MATTER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'EMAIL', 'WEBSITE', 'DATE', 'DESC', 'ACTION', 'MATTER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'email', 'website', 'date', 'desc', 'action', 'matter_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Email' => 2, 'Website' => 3, 'Date' => 4, 'Desc' => 5, 'Action' => 6, 'MatterId' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'website' => 3, 'date' => 4, 'desc' => 5, 'action' => 6, 'matterId' => 7, ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID => 0, CommentPeer::NAME => 1, CommentPeer::EMAIL => 2, CommentPeer::WEBSITE => 3, CommentPeer::DATE => 4, CommentPeer::DESC => 5, CommentPeer::ACTION => 6, CommentPeer::MATTER_ID => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'EMAIL' => 2, 'WEBSITE' => 3, 'DATE' => 4, 'DESC' => 5, 'ACTION' => 6, 'MATTER_ID' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'website' => 3, 'date' => 4, 'desc' => 5, 'action' => 6, 'matter_id' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentPeer::NAME);
            $criteria->addSelectColumn(CommentPeer::EMAIL);
            $criteria->addSelectColumn(CommentPeer::WEBSITE);
            $criteria->addSelectColumn(CommentPeer::DATE);
            $criteria->addSelectColumn(CommentPeer::DESC);
            $criteria->addSelectColumn(CommentPeer::ACTION);
            $criteria->addSelectColumn(CommentPeer::MATTER_ID);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.matter_id');
        }
    }
    ...
    {
        // Invalidate objects in GapPeer instance pool,
    ...
    /**
     * Returns the number of rows matching criteria, joining the related Matter table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinMatter(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::MATTER_ID, MatterPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their Matter objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinMatter(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = MatterPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = MatterPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    MatterPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Comment) to $obj2 (Matter)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        MatterPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + MatterPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined Matter rows

            $key2 = MatterPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = MatterPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (Matter)
                $obj2->addComment($obj1);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            CommentPeer::doOnDeleteSetNull(new Criteria(CommentPeer::DATABASE_NAME), $con);
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // set fkey col in related Gap rows to null
            $selectCriteria = new Criteria(CommentPeer::DATABASE_NAME);
            $updateValues = new Criteria(CommentPeer::DATABASE_NAME);
            $selectCriteria->add(GapPeer::COMMENT_ID, $obj->getId());
            $updateValues->add(GapPeer::COMMENT_ID, null);
