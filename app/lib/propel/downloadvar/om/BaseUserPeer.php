...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Username', 'Password', 'Email', 'Mobile', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'username', 'password', 'email', 'mobile', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::NAME, UserPeer::USERNAME, UserPeer::PASSWORD, UserPeer::EMAIL, UserPeer::MOBILE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'USERNAME', 'PASSWORD', 'EMAIL', 'MOBILE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'username', 'password', 'email', 'mobile', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Username' => 2, 'Password' => 3, 'Email' => 4, 'Mobile' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'username' => 2, 'password' => 3, 'email' => 4, 'mobile' => 5, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::NAME => 1, UserPeer::USERNAME => 2, UserPeer::PASSWORD => 3, UserPeer::EMAIL => 4, UserPeer::MOBILE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'USERNAME' => 2, 'PASSWORD' => 3, 'EMAIL' => 4, 'MOBILE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'username' => 2, 'password' => 3, 'email' => 4, 'mobile' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $selectCriteria->add(MatterPeer::USER_ID, $obj->getId());
            $updateValues->add(MatterPeer::USER_ID, null);
