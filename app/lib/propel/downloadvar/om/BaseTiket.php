...
abstract class BaseTiket extends BaseObject implements Persistent
{
    ...
    public function setCategory($v)
    {
        ...
        if ($this->category !== $v) {
            $this->category = $v;
            $this->modifiedColumns[] = TiketPeer::CATEGORY;
        }
    ...
    public function setAction($v)
    {
        ...
        if ($this->action !== $v) {
            $this->action = $v;
            $this->modifiedColumns[] = TiketPeer::ACTION;
        }
    ...
    public function setIncrease($v)
    {
        ...
        if ($this->increase !== $v) {
            $this->increase = $v;
            $this->modifiedColumns[] = TiketPeer::INCREASE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->increase = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`action`':
                        ...
                        break;
                    case '`increase`':
                        $stmt->bindValue($identifier, $this->increase, PDO::PARAM_INT);
                        break;
                    case '`date`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setIncrease($arr[$keys[7]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TiketPeer::CATEGORY)) $criteria->add(TiketPeer::CATEGORY, $this->category);
        if ($this->isColumnModified(TiketPeer::ORDER)) $criteria->add(TiketPeer::ORDER, $this->order);
        if ($this->isColumnModified(TiketPeer::ACTION)) $criteria->add(TiketPeer::ACTION, $this->action);
        if ($this->isColumnModified(TiketPeer::INCREASE)) $criteria->add(TiketPeer::INCREASE, $this->increase);
