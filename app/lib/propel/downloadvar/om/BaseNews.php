...
abstract class BaseNews extends BaseObject implements Persistent
{
    ...
    public function setDesc($v)
    {
        ...
        if ($this->desc !== $v) {
            $this->desc = $v;
            $this->modifiedColumns[] = NewsPeer::DESC;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = NewsPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NewsPeer::SUBJECT)) {
            $modifiedColumns[':p' . $index++]  = '`subject`';
        }
        if ($this->isColumnModified(NewsPeer::ORDER)) {
            $modifiedColumns[':p' . $index++]  = '`order`';
        }
        if ($this->isColumnModified(NewsPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(NewsPeer::DESC)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsPeer::SUBJECT)) $criteria->add(NewsPeer::SUBJECT, $this->subject);
        ...
        if ($this->isColumnModified(NewsPeer::DESC)) $criteria->add(NewsPeer::DESC, $this->desc);
