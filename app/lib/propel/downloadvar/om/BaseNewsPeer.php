...
abstract class BaseNewsPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Subject', 'Order', 'Date', 'Desc', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'subject', 'order', 'date', 'desc', ),
        BasePeer::TYPE_COLNAME => array (NewsPeer::ID, NewsPeer::SUBJECT, NewsPeer::ORDER, NewsPeer::DATE, NewsPeer::DESC, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SUBJECT', 'ORDER', 'DATE', 'DESC', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'subject', 'order', 'date', 'desc', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Subject' => 1, 'Order' => 2, 'Date' => 3, 'Desc' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'subject' => 1, 'order' => 2, 'date' => 3, 'desc' => 4, ),
        BasePeer::TYPE_COLNAME => array (NewsPeer::ID => 0, NewsPeer::SUBJECT => 1, NewsPeer::ORDER => 2, NewsPeer::DATE => 3, NewsPeer::DESC => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SUBJECT' => 1, 'ORDER' => 2, 'DATE' => 3, 'DESC' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'subject' => 1, 'order' => 2, 'date' => 3, 'desc' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsPeer::SUBJECT);
            $criteria->addSelectColumn(NewsPeer::ORDER);
            $criteria->addSelectColumn(NewsPeer::DATE);
            $criteria->addSelectColumn(NewsPeer::DESC);
        } else {
